; RUN: llc -mtriple=i686-unknown-nacl -filetype=asm %s -o - \
; RUN:   | FileCheck %s --check-prefix=NACL32
; RUN: llc -mtriple=i686-unknown-nacl -filetype=asm -O0 %s -o - \
...
; RUN: llc -mtriple=x86_64-unknown-nacl -filetype=asm -O0 %s -o - \
; RUN:   | FileCheck %s --check-prefix=NACL64
