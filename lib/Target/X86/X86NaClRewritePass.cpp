...
bool X86NaClRewritePass::ApplyControlSFI(MachineBasicBlock &MBB,
  ...
  case X86::JMP32m               : NewOpc = X86::NACL_JMP32r; break;
  ...
  if (Opc == (Subtarget->is64Bit() ? X86::RETQ : X86::RETL) ||
      Opc == X86::EH_RETURN || Opc == X86::EH_RETURN64 ||
      Opc == (Subtarget->is64Bit() ? X86::RETIQ : X86::RETIL)) {
    ...
    if (Is64Bit) {
      ...
      if (Opc == (Subtarget->is64Bit() ? X86::RETIQ : X86::RETIL)) {
